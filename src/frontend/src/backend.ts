...
export class Backend implements backendInterface {
    ...
    async getOwnProfileImageId(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnProfileImageId();
    ...
    async getPartnerTyping(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getPartnerTyping();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfilePictureId(arg0: Principal): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getProfilePictureId(arg0);
                return from_candid_opt_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUnreadMessageCount(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async hasImageId(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasImageId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async login(arg0: LoginInput): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async register(arg0: RegistrationInput): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: MessageInput): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        typingTimestamp: value.typingTimestamp,
        profileImageId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.profileImageId)),
        name: value.name,
